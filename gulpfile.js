...
gulp.task('scripts', function() {
	return gulp.src([ 
		...
		'src/template/libs/fullpage.js/jquery.fullPage.js',
		'src/template/libs/fullpage.js/vendors/jquery.easings.min.js',
		'src/template/libs/fullpage.js/vendors/scrolloverflow.min.js'
		])
		.pipe(concat('libs.js')) 
